    ...
    for target_path, predicted_path in zip(target_paths, predicted_paths):
        ...
        with codecs.open(target_path, 'r', 'utf-8') as target, codecs.open(predicted_path, 'r', 'utf-8') as predicted:
            ...
            while True:
                ...
                if target_stream[t_i] in data.PUNCTUATION_VOCABULARY:
                ...
                #print target_stream[t_i], t_i, predicted_stream[p_i], p_i
                #print ' '.join(target_stream[t_i-2:t_i+2]), ' '.join(predicted_stream[p_i-2:p_i+2])
