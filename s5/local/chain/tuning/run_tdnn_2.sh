...
if [ ! $# = 2 ]; then
  ...
  echo ""
  echo "Usage: $0 [options] <input-training-data-dir> <test-data-dir>"
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn5 $opts dim=1536 input=Append(tdnn5l, tdnn3l)
  ...
  relu-batchnorm-layer name=tdnn9 $opts input=Append(0,3,tdnn8l,tdnn6l,tdnn4l) dim=1536
  linear-component name=tdnn10l dim=256 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn10 $opts input=Append(0,3) dim=1536
  linear-component name=tdnn11l dim=256 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn11 $opts input=Append(0,3,tdnn10l,tdnn8l,tdnn6l) dim=1536
