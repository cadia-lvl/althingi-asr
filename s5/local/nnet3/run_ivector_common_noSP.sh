...
if [ $stage -le 1 ]; then
  ...
  # Make a subset containing 15% of the original training set
  utils/subset_data_dir.sh data/train_hires 28300 data/train_15p_hires || exit 1
fi
...
if [ $stage -le 2 ]; then
  ...
  steps/align_fmllr.sh --nj 40 --cmd "$train_cmd" \
    data/train_40k data/lang_bd exp/tri3 exp/nnet3/tri3_ali_p15
fi
...
if [ $stage -le 3 ]; then
  ...
  steps/train_lda_mllt.sh --cmd "$train_cmd" --num-iters 13 \
    ...
    5000 10000 data/train_15p_hires data/lang_bd \
     exp/nnet3/tri3_ali_p15 exp/nnet3/tri4
fi
...
if [ $stage -le 4 ]; then
  ...
  steps/online/nnet2/train_diag_ubm.sh --cmd "$train_cmd" --nj 30 \
     --num-frames 400000 data/train_15p_hires 256 exp/nnet3/tri4 exp/nnet3/diag_ubm
fi
...
if [ $stage -le 6 ]; then
  ...
  # NOTE! this script is deprecated, please use utils/data/modify_speaker_info.sh
